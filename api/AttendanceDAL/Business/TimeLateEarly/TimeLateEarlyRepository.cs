...
{
    public class TimeLateEarlyRepository : TLARepository<TimeLateEarly>, ITimeLateEarlyRepository
    {
        ...
        public async Task<ResultWithError> CreateAsync(TimeLateEarlyInputDTO param)
        {
            ...
            try
            {
                var data = Map<TimeLateEarlyInputDTO, RegisterOff>(param, new RegisterOff());
        ...
        public async Task<ResultWithError> UpdateAsync(TimeLateEarlyInputDTO param)
        {
            try
            {
                ...
                var data = Map<TimeLateEarlyInputDTO, RegisterOff>(param, r);
                data.STATUS_ID = OtherConfig.STATUS_WAITING;
