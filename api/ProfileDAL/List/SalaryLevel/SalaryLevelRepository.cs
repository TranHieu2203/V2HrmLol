...
{
    public class SalaryLevelRepository : TLARepository<SalaryLevel>, ISalaryLevelRepository
    {
        ...
        public async Task<ResultWithError> CreateAsync(SalaryLevelInputDTO param)
        {
            try
            {
                ...
                var data = Map<SalaryLevelInputDTO, SalaryLevel>(param, new SalaryLevel());
                data.IS_ACTIVE = true;
        ...
        public async Task<ResultWithError> UpdateAsync(SalaryLevelInputDTO param)
        {
            try
            {
                ...
                var data = Map<SalaryLevelInputDTO, SalaryLevel>(param, r);
