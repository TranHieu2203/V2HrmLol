...
namespace ProfileDAL.Models
{
    ...
    public class ViewOrganization
    {
        ...
        public int ORG_CODE1 { get; set; }

        public int ORG_CODE2 { get; set; }

        public int ORG_CODE3 { get; set; }

        public int ORG_CODE4 { get; set; }

        public int ORG_CODE5 { get; set; }

        public int ORG_CODE6 { get; set; }

        public int ORG_CODE7 { get; set; }

        public int ORG_CODE8 { get; set; }

        public int ORG_CODE10 { get; set; }

        public int ORG_CODE11 { get; set; }
