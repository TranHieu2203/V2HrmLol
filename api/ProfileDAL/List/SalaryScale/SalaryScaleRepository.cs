...
{
    public class SalaryScaleRepository : TLARepository<SalaryScale>, ISalaryScaleRepository
    {
        ...
        public async Task<ResultWithError> CreateAsync(SalaryScaleInputDTO param)
        {
            try
            {
                ...
                var data = Map<SalaryScaleInputDTO, SalaryScale>(param, new SalaryScale());
                data.IS_ACTIVE = true;
        ...
        public async Task<ResultWithError> UpdateAsync(SalaryScaleInputDTO param)
        {
            try
            {
                ...
                var data = Map<SalaryScaleInputDTO, SalaryScale>(param, r);
