...
{
    public class CommendRepository : TLARepository<Commend>, ICommendRepository
    {
        ...
        public async Task<ResultWithError> CreateAsync(CommendInputDTO param)
        {
            try
            {
                ...
                var data = Map<CommendInputDTO, Commend>(param, new Commend());
                //data.NO = CommendNo;
        ...
        public async Task<ResultWithError> UpdateAsync(CommendInputDTO param)
        {
            try
            {
                ...
                var data = Map<CommendInputDTO, Commend>(param, r);
