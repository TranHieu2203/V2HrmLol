...
{
    public class GroupPositionSysRepository : TLARepository<GroupPositionSys>, IGroupPositionSysRepository
    {
        ...
        public async Task<ResultWithError> CreateAsync(GroupPositionSysInputDTO param)
        {
            ...
            var data = Map<GroupPositionSysInputDTO, GroupPositionSys>(param, new GroupPositionSys());
            data.IS_ACTIVE = true;
        ...
        public async Task<ResultWithError> UpdateAsync(GroupPositionSysInputDTO param)
        {
            ...
            var data = Map<GroupPositionSysInputDTO, GroupPositionSys>(param, r);
