...
{
    public class PositionSysRepository : TLARepository<PositionSys>, IPositionSysRepository
    {
        ...
        public async Task<ResultWithError> CreateAsync(PositionSysInputDTO param)
        {
            try
            {
                ...
                var data = Map<PositionSysInputDTO, PositionSys>(param, new PositionSys());
                data.IS_ACTIVE = true;
                var result = await _appContext.PositionSyses.AddAsync(data);
                await _appContext.SaveChangesAsync();
                //return data
                var output = new PositionSysOutputDTO();
                var values = Map<PositionSys, PositionSysOutputDTO>(data, output);
        ...
        public async Task<ResultWithError> UpdateAsync(PositionSysInputDTO param)
        {
            try
            {
                ...
                var data = Map<PositionSysInputDTO, PositionSys>(param, a);
