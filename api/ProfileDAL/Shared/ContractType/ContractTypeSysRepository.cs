...
{
    public class ContractTypeSysRepository : TLARepository<ContractTypeSys>, IContractTypeSysRepository
    {
        ...
        public async Task<ResultWithError> CreateAsync(ContractTypeSysInputDTO param)
        {
            ...
            try
            {
                ...
                var data = Map<ContractTypeSysInputDTO, ContractTypeSys>(param, new ContractTypeSys());
                data.IS_ACTIVE = true;
                var result = await _appContext.ContractTypeSyses.AddAsync(data);
                await _appContext.SaveChangesAsync();
                //return data
                var output = new ContractTypeSysOutputDTO();
                var values = Map<ContractTypeSys, ContractTypeSysOutputDTO>(data, output);
        ...
        public async Task<ResultWithError> UpdateAsync(ContractTypeSysInputDTO param)
        {
            try
            {
                ...
                var data = Map<ContractTypeSysInputDTO, ContractTypeSys>(param, r);
