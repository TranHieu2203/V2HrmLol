...
{
    public class InsuranceTypeRepository : TLARepository<InsuranceType>, IInsuranceTypeRepository
    {
        ...
        public async Task<ResultWithError> CreateAsync(InsuranceTypeInputDTO param)
        {
            try
            {
                var data = Map<InsuranceTypeInputDTO, InsuranceType>(param, new InsuranceType());
                data.IS_ACTIVE = true;
        ...
        public async Task<ResultWithError> UpdateAsync(InsuranceTypeInputDTO param)
        {
            ...
            {                
                ...
                var data = Map<InsuranceTypeInputDTO, InsuranceType>(param, r);
