...
{
    public class SalaryStructureSysRepository : TLARepository<SalaryStructSys>, ISalaryStructureSysRepository
    {
        ...
        public async Task<ResultWithError> CreateAsync(SalaryStructureSysInputDTO param)
        {
            try
            {
                ...
                var data = Map<SalaryStructureSysInputDTO, SalaryStructSys>(param, new SalaryStructSys());
        ...
        public async Task<ResultWithError> UpdateAsync(SalaryStructureSysInputDTO param)
        {
            try
            {
                ...
                var data = Map<SalaryStructureSysInputDTO, SalaryStructSys>(param, r);
