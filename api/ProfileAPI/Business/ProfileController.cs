...
namespace ProfileAPI.List
{
    ...
    [Route("api/client/Profile/[action]")]
    public class ProfileController : BaseController1
    {
        public ProfileController(IProfileBusiness unitOfWork) : base(unitOfWork)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult> GetBankList([FromBody] BankDTO param)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult> GetListLearningLevel([FromBody] OtherListDTO param)
        {
            param.Name = OtherListConst.LEARNING_LEVEL;
            var r = await _unitOfWork.EmployeeRepository.GetOtherListByType(param);
            return Ok(r);
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<ActionResult> GetListTrainingForm([FromBody] OtherListDTO param)
        {
            param.Name = OtherListConst.TRAINING_FORM;
            var r = await _unitOfWork.EmployeeRepository.GetOtherListByType(param);
            return Ok(r);
        }
    }
