...
{
    public class SysModuleRepository : TLARepository<SysModule>, ISysModuleRepository
    {
        ...
        public async Task<ResultWithError> CreateAsync(SysModuleInputDTO param)
        {
            ...
            var data = Map<SysModuleInputDTO, SysModule>(param, new SysModule());
            data.IS_ACTIVE = true;
        ...
        public async Task<ResultWithError> UpdateAsync(SysModuleInputDTO param)
        {
            ...
            var data = Map<SysModuleInputDTO, SysModule>(param, r);
