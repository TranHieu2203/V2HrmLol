...
{
    public class ApproveTemplateRepository : TLARepository<ApproveTemplate>, IApproveTemplateRepository
    {
        ...
        public async Task<ResultWithError> GetApproveTemplateById(int id)
        {
        ...
        public async Task<ResultWithError> CreateApproveTemplate(ApproveTemplateDTO param)
        {
            try
            {
                var data = Map<ApproveTemplateDTO, ApproveTemplate>(param, new ApproveTemplate());
                data.ACTFLG = "A";
        ...
        public async Task<ResultWithError> UpdateApproveTemplate(ApproveTemplateDTO param)
        {
            try
            {
                ...
                var data = Map<ApproveTemplateDTO, ApproveTemplate>(param, r);
                data.MODIFIED_DATE = DateTime.Now;
        ...
        public async Task<ResultWithError> DeleteApproveTemplate(List<int> ids)
        {
            try
            {
        ...
        public async Task<PagedResult<ApproveTemplateDetailDTO>> GetApproveTemplateDetail(int templateId)
        {
            var queryable = from a in _appContext.ApproveTemplateDetails
                            ...
                            select new ApproveTemplateDetailDTO
                            {
                                ...
                                EmployeeName = a.APP_TYPE == 1 ? e.FULLNAME : "",
        ...
        public async Task<ResultWithError> GetApproveTemplateDetailById(int id)
        {
        ...
        public async Task<ResultWithError> CreateApproveTemplateDetail(ApproveTemplateDetailDTO param)
        {
            try
            {
                var data = Map<ApproveTemplateDetailDTO, ApproveTemplateDetail>(param, new ApproveTemplateDetail());
                data.CREATED_DATE = DateTime.Now;
                data.MODIFIED_DATE = DateTime.Now;
        ...
        public async Task<ResultWithError> UpdateApproveTemplateDetail(ApproveTemplateDetailDTO param)
        {
            try
            {
                ...
                var data = Map<ApproveTemplateDetailDTO, ApproveTemplateDetail>(param, r);
                data.MODIFIED_DATE = DateTime.Now;
        ...
        public async Task<ResultWithError> DeleteApproveTemplateDetail(List<int> ids)
        {
            try
            {
