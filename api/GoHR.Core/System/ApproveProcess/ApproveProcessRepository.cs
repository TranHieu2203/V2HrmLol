...
{
    public class ApproveProcessRepository : TLARepository<ApproveProcess>, IApproveProcessRepository
    {
        ...
        public async Task<PagedResult<ApproveProcessDTO>> GetAll(ApproveProcessDTO param, int application)
        {
        ...
        public async Task<ResultWithError> UpdateAsync(ApproveProcessDTO param, int application)
        {
            try
            {
