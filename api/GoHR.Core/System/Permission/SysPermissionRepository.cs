...
{
    public class SysPermissionRepository : TLARepository<SysPermission>, ISysPermissionRepository
    {
        ...
        public async Task<ResultWithError> CreateAsync(SysPermissionInputDTO param)
        {
            ...
            var data = Map<SysPermissionInputDTO, SysPermission>(param, new SysPermission());
            data.IS_ACTIVE = true;
        ...
        public async Task<ResultWithError> UpdateAsync(SysPermissionInputDTO param)
        {
            ...
            var data = Map<SysPermissionInputDTO, SysPermission>(param, r);
