...
{
    public class KpiFormulaRepository : TLARepository<KpiFormula>, IKpiFormulaRepository
    {
        ...
        public async Task<ResultWithError> UpdateAsync(KpiFormulaCreateDTO param)
        {
            try
            {
                ...
                if (param.Id == null)
                {
                    var data = Map<KpiFormulaCreateDTO, KpiFormula>(param, new KpiFormula());
                    data.IS_ACTIVE = true;
                ...
                else
                {
                    ...
                    var data = Map<KpiFormulaCreateDTO, KpiFormula>(param, r);
                    data.FORMULA_NAME = fomulaName;
