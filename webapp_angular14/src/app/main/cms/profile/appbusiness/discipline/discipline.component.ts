...
export class DisciplineComponent implements OnInit {
  ...
  viewRecord = (event: any) => {
    ...
    this.router.navigate(["/cms/profile/business/discipline/", paramAdd]);
  };
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(state, "hr/discipline/GetAll", extraParams);
  };
  GetEmp = (e: any) => {
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/cms/profile/business/discipline/new"]);
        break;
        ...
        if (selectDeletes && selectDeletes.length > 0) {
          ...
          if (
            ...
            this.router.navigate([
              "/cms/profile/business/discipline/",
              paramAdd,
            ]);
          } else {
