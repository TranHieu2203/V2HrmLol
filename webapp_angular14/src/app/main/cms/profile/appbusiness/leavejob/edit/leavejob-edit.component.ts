...
import { LeaveJob } from "src/app/_models/app/cms";
setCulture("en");
...
export class LeaveJobEditComponent implements OnInit {
  ...
  constructor(
    ...
    this.editForm = this._formBuilder.group({
      ...
      contractNo: [{ value: "", disabled: true }, [Validators.required]],
    ...
    switch (buttonId) {
      case ToolbarItem.BACK:
        ...
        if (this.flagePopup === true) {
          this.router.navigate(["cms/profile/business/leavejob"]);
        }
        break;
  ...
  convertModel(param: any) {
    ...
    model.sendDate = param.sendDate
      ? moment(param.sendDate).format("MM/DD/YYYY")
      : null;
    model.lastDate = param.lastDate
      ? moment(param.lastDate).format("MM/DD/YYYY")
      : null;
    return model;
  }
  // change date
