...
export class LeaveJobComponent implements OnInit {
  toolItems$ = new BehaviorSubject<any[]>([
    ToolbarItem.ADD, ToolbarItem.EDIT, ToolbarItem.DELETE, ToolbarItem.PRINT
  ])
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(state, "hr/terminate/GetAll", extraParams);
  };
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/cms/profile/business/leavejob/new"]);
        break;
