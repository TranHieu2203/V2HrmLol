...
export class AllowanceComponent implements OnInit {
  ...
  viewRecord = (event: any) => {
    ...
    this.router.navigate(["/cms/profile/list/allowance/", paramAdd]);
  };
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(state, "hr/allowance/GetAll");
  ...
  public dataStateChange(state: DataStateChangeEventArgs): void {
    ...
    let extraParams: any[] = [];
    this._coreService.execute(state, "hr/allowance/GetAll", extraParams);
  }
  // Số thứ tự
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/cms/profile/list/allowance/new"]);
        break;
