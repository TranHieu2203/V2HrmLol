...
export class GroupPositionComponent implements OnInit {
  ...
  viewRecord = (event: any) => {
    ...
    this.router.navigate(["/cms/profile/list/groupposition/", paramAdd]);
  };
  ...
  getListData = (): void => {
    ...
    // console.log('>>>>>',state)
    this._coreService.execute(state, "hr/groupposition/GetAll");
  };

  public dataStateChange(state: DataStateChangeEventArgs): void {
    this.pageIndex = Math.floor(state.skip! / state.take!);
    let extraParams: any[] = [];
    this._coreService.execute(state, "hr/groupposition/GetAll", extraParams);
  }
  // Số thứ tự
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/cms/profile/list/groupposition/new"]);
        break;
