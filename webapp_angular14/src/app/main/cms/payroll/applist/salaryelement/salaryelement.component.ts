...
export class SalaryElementComponent implements OnInit {
  ...
  viewRecord = (event: any) => {
    ...
    this.router.navigate(["/cms/payroll/list/salaryelement/", paramAdd]);
  };
  ...
  getListData = (groupId: any): void => {
    ...
    this._coreService.execute(state, "payroll/element/GetAll", extraParams);
  };
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/cms/payroll/list/salaryelement/new"]);
        break;
      case ToolbarItem.EDIT:
        ...
        if (selectRows && selectRows.length > 0) {
          ...
          this.router.navigate([
            "/cms/payroll/list/salaryelement/",
            paramAdd,
          ]);
        } else {
