...
export class JobBandComponent implements OnInit {
  ...
  viewRecord = (event: any) => {
    ...
    this.router.navigate(["/cms/organize/list/job-band/", paramAdd]);
  };
  ...
  getListData = () => {
    ...
    this._coreService.execute(state, "hr/job-band/job-bands");
  };
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/cms/organize/list/job-band/new"]);
        break;
