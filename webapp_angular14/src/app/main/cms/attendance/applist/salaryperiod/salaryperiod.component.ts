...
export class SalaryPeriodComponent implements OnInit {
  ...
  viewRecord = (event: any) => {
    ...
    this.router.navigate(["/cms/attendance/list/salaryperiod/", paramAdd]);
  };
  ...
  getListData = (year: any): void => {
    ...
    this._coreService.execute(state, "hr/salaryperiod/GetAll", extraParams);
  };
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/cms/attendance/list/salaryperiod/new"]);
        break;
