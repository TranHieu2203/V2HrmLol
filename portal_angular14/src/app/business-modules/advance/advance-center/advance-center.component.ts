...
@Component({
  selector: 'app-advance-center',
  templateUrl: './advance-center.component.html',
  styleUrls: ['./advance-center.component.css'],
  encapsulation: ViewEncapsulation.None,
})
export class AdvanceCenterComponent implements OnInit, OnDestroy {
