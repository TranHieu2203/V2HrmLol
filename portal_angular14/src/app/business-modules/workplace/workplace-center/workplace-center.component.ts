...
@Component({
  selector: 'app-workplace-center',
  templateUrl: './workplace-center.component.html',
  styleUrls: ['./workplace-center.component.css'],
  encapsulation: ViewEncapsulation.None,
})
export class WorkplaceCenterComponent implements OnInit, OnDestroy {
