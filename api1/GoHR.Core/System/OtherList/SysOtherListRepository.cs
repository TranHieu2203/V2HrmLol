...
{
    public class SysOtherListRepository : TLARepository<SysOtherListType>, ISysOtherListRepository
    {
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        public async Task<PagedResult<SysOtherList>> CMSGetByType(SysOtherListDTO param)
        {
            ...
            {
                queryable = queryable.Where(p => p.TYPE_ID == param.Type_Id);
            }
            if (param.Name != null)
            {
        ...
        public async Task<ResultWithError> CreateTypeAsync(SysOtherListTypeInputDTO param)
        {
            ...
            var data = Map<SysOtherListTypeInputDTO, SysOtherListType>(param, new SysOtherListType());
            data.IS_ACTIVE = true;
        ...
        public async Task<ResultWithError> UpdateTypeAsync(SysOtherListTypeInputDTO param)
        {
            ...
            var data = Map<SysOtherListTypeInputDTO, SysOtherListType>(param, r);
        ...
        public async Task<ResultWithError> CreateAsync(SysOtherListInputDTO param)
        {
            ...
            var data = Map<SysOtherListInputDTO, SysOtherList>(param, new SysOtherList());
            data.IS_ACTIVE = true;
        ...
        public async Task<ResultWithError> UpdateAsync(SysOtherListInputDTO param)
        {
            ...
            var data = Map<SysOtherListInputDTO, SysOtherList>(param, r);
