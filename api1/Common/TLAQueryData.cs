...
namespace Common.DataAccess
{
    public class TLAQueryData
    {
        ...
        private TLAContext _tlaContext;
        public TLAQueryData(TLAContext tlaContext)
        {
            ...
            connet = tlaContext.Database.GetDbConnection();
            _tlaContext = tlaContext;
        ...
        public async Task<object> ExecuteStoreQuery(string sql)
        {
        ...
        public async Task<List<T>> ExecuteStore<T>(string sql, object obj) where T : new()
        {
            string strPosOut = "";
            OracleConnection conn = new OracleConnection(connet.ConnectionString);
            OracleCommand cmd = new OracleCommand(sql, conn);
        ...
        // <param name="obj">Đối tượng chưa parameter</param>
        // <returns>Dữ liệu trả về Entity</returns>
        public async Task<List<T>> ExecuteStore<T>(string sql, object obj, bool? haveUserTenant) where T : new()
        {
            string strPosOut = "";
            OracleConnection conn = new OracleConnection(connet.ConnectionString);
            OracleCommand cmd = new OracleCommand(sql, conn);
            ...
            if (haveUserTenant != null && haveUserTenant == true)
            {
                ...
                User.Value = _tlaContext.CurrentUserId;
        ...
        public async Task<List<T>> ExecuteStorePortal<T>(string sql, object obj) where T : new()
        {
            string strPosOut = "";
            OracleConnection conn = new OracleConnection(connet.ConnectionString);
            OracleCommand cmd = new OracleCommand(sql, conn);
        ...
        public async Task<string> ExecuteStoreString(string sql, object obj)
        {
            string strPosOut = "";
            OracleConnection conn = new OracleConnection(connet.ConnectionString);
            OracleCommand cmd = new OracleCommand(sql, conn);
            conn.Open();
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
            cmd.Parameters.Add("P_USER_ID", _tlaContext.CurrentUserId);
            // Add parameter
            if (obj != null)
            {
                foreach (PropertyInfo info in obj.GetType().GetProperties())
        ...
        public async Task<PagedResult<T>> ExecuteStorePage<T>(string sql, object obj) where T : new()
        {
            string strPosOut = "";
            OracleConnection conn = new OracleConnection(connet.ConnectionString);
            OracleCommand cmd = new OracleCommand(sql, conn);
        ...
        /// <returns></returns>
        public async Task<List<List<ExpandoObject>>> ExecuteStoreObject(string sql, object obj, bool? haveUserTenant)
        {
            string strPosOut = "";
            OracleConnection conn = new OracleConnection(connet.ConnectionString);
            OracleCommand cmd = new OracleCommand(sql, conn);
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public async Task<PagedResult<ExpandoObject>> ExecutePaging(string sql, object obj, bool? haveUserTenant)
        {
            try
            {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public async Task<int> ExecuteNonQuery(string sql, object obj, bool? haveUserTenant)
        {
            string strPosOut = "";
            OracleConnection conn = new OracleConnection(connet.ConnectionString);
            OracleCommand cmd = new OracleCommand(sql, conn);
        ...
        public async Task<List<ExpandoObject>> ExecuteList(string sql, object obj, bool? haveUserTenant)
        {
            try
            {
                var data = await ExecuteStoreObject(sql, obj, haveUserTenant);
        ...
        public async Task<ExpandoObject> ExecuteObject(string sql, object obj, bool? haveUserTenant)
        {
            try
            {
                var data = await ExecuteStoreObject(sql, obj, haveUserTenant);
        ...
        public async Task Execute(string sql, object obj, bool? haveUserTenant)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public async Task<List<List<ExpandoObject>>> ExecuteStoreObject(string conect, string sql, object obj)
        {
            string strPosOut = "";
            var conectionString = _tlaContext._config[conect];
        ...
        public async Task Execute(string conect, string sql, object obj)
        {
            await ExecuteStoreObject(conect, sql, obj);

        }
        public async Task<List<ExpandoObject>> ExecuteList(string conect, string sql, object obj)
        {
            try
            {
        ...
        // <param name="obj">Đối tượng chưa parameter</param>
        // <returns>Dữ liệu trả về</returns>
        public DataSet ExecuteStoreToTable(string sql, object obj, bool? haveUserTenant)
        {
            string strPosOut = "";
            OracleConnection conn = new OracleConnection(connet.ConnectionString);
            OracleCommand cmd = new OracleCommand(sql, conn);
        ...
        /// <param name="dt"></param>
        /// <returns></returns>
        public List<T> ConvertToListByOrder<T>(DataTable dt)
        {
