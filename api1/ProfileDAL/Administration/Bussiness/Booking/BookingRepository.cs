...
{
    public class BookingRepository : TLARepository<Booking>, IBookingRepository
    {
        ...
        public async Task<ResultWithError> PortalReg(BookingInputDTO param)
        {
            ...
            var data = Map<BookingInputDTO, Booking>(param, new Booking());
        ...
        public async Task<ResultWithError> PortalEditReg(BookingInputDTO param)
        {
            ...
            var data = Map<BookingInputDTO, Booking>(param, r);
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public async Task<ResultWithError> PortalDelete(int id)
        {
            try
            {
        ...
        /// <returns></returns>
        public async Task<ResultWithError> ChangeStatusAsync(int id, int statusId, string note)
        {
        ...
        public async Task<ResultWithError> PortalGetBy(int id)
        {
            var queryable = await (from p in _appContext.Bookings
                                   join r in _appContext.Rooms on p.ROOM_ID equals r.ID
                                   from a in _appContext.Employees.Where(x=>x.ID == p.APPROVED_ID).DefaultIfEmpty()
