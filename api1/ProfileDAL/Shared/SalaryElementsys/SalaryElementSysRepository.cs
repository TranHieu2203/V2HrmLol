...
{
    public class SalaryElementSysRepository : TLARepository<SalaryElementSys>, ISalaryElementSysRepository
    {
        ...
        public async Task<ResultWithError> CreateAsync(SalaryElementSysInputDTO param)
        {
            try
            {
                ...
                // 
                var data = Map<SalaryElementSysInputDTO, SalaryElementSys>(param, new SalaryElementSys());
                data.IS_ACTIVE = true;
        ...
        public async Task<ResultWithError> UpdateAsync(SalaryElementSysInputDTO param)
        {
            ...
            {   
                ...
                //}
                var data = Map<SalaryElementSysInputDTO, SalaryElementSys>(param, r);
