...
{
    public class ThemeBlogRepository : TLARepository<ThemeBlog>, IThemeBlogRepository
    {
        ...
        public async Task<ResultWithError> CreateAsync(ThemeBlogInputDTO param)
        {
            try
            {
                var data = Map<ThemeBlogInputDTO, ThemeBlog>(param, new ThemeBlog());
                data.IS_ACTIVE = true;
        ...
        public async Task<ResultWithError> UpdateAsync(ThemeBlogInputDTO param)
        {
            try
            {
                ...
                var data = Map<ThemeBlogInputDTO, ThemeBlog>(param, r);
