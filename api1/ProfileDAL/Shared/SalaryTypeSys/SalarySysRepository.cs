...
{
    public class SalarySysRepository : TLARepository<SalaryTypeSys>, ISalarySysRepository
    {
        ...
        public async Task<ResultWithError> CreateAsync(SalaryTypeSysInputDTO param)
        {
            try
            {
                ...
                var data = Map<SalaryTypeSysInputDTO, SalaryTypeSys>(param, new SalaryTypeSys());
                data.IS_ACTIVE = true;
        ...
        public async Task<ResultWithError> UpdateAsync(SalaryTypeSysInputDTO param)
        {
            try
            {
                ...
                var data = Map<SalaryTypeSysInputDTO, SalaryTypeSys>(param, r);
