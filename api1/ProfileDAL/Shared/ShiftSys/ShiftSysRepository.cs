...
{
    public class ShiftSysRepository : TLARepository<ShiftSys>, IShiftSysRepository
    {
        ...
        public async Task<ResultWithError> CreateAsync(ShiftSysInputDTO param)
        {
            try
            {
                ...
                var data = Map<ShiftSysInputDTO, ShiftSys>(param, new ShiftSys());
                data.IS_ACTIVE = true;
        ...
        public async Task<ResultWithError> UpdateAsync(ShiftSysInputDTO param)
        {
            try
            {
                ...
                param.Code = null;
                var data = Map<ShiftSysInputDTO, ShiftSys>(param, r);
        ...
        public async Task<ResultWithError> UpdateShiftCycle(ShiftCycleSysInput param)
        {
            try
            {
                ...
                var data = Map<ShiftCycleSysInput, ShiftSys>(param, r);
                var result = _appContext.ShiftSyses.Update(data);
                await _appContext.SaveChangesAsync();
                return new ResultWithError(200);
            }
