...
{
    public class SalaryRankRepository : TLARepository<SalaryRank>, ISalaryRankRepository
    {
        ...
        public async Task<ResultWithError> CreateAsync(SalaryRankInputDTO param)
        {
            ...
            try
            {
                ...
                var data = Map<SalaryRankInputDTO, SalaryRank>(param, new SalaryRank());
                data.IS_ACTIVE = true;
        ...
        public async Task<ResultWithError> UpdateAsync(SalaryRankInputDTO param)
        {
            try
            {
                ...
                var data = Map<SalaryRankInputDTO, SalaryRank>(param, r);
                data.IS_ACTIVE = true;
