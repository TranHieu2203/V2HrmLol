...
{
    public class SettingMapRepository : TLARepository<SettingMap>, ISettingMapRepository
    {
        ...
        public async Task<ResultWithError> CreateAsync(SettingMapInputDTO param)
        {
            try
            {
                ...
                var data = Map<SettingMapInputDTO, SettingMap>(param, new SettingMap());
                data.IS_ACTIVE = true;
        ...
        public async Task<ResultWithError> UpdateAsync(SettingMapInputDTO param)
        {
            try
            {
                ...
                var data = Map<SettingMapInputDTO, SettingMap>(param, a);
                data.IS_ACTIVE = true;
                if (a.QRCODE == null)
                {
                    data.QRCODE = Guid.NewGuid().ToString();
