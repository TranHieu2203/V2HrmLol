...
{
    public class TimeTypeRepository : TLARepository<TimeType>, ITimeTypeRepository
    {
        ...
        public async Task<ResultWithError> CreateAsync(TimeTypeInputDTO param)
        {
            try
            {
                ...
                var data = Map<TimeTypeInputDTO, TimeType>(param, new TimeType());
        ...
        public async Task<ResultWithError> UpdateAsync(TimeTypeInputDTO param)
        {
            try
            {
                ...
                var data = Map<TimeTypeInputDTO, TimeType>(param, r);
