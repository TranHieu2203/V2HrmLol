...
{
    public class ElementGroupRepository : TLARepository<ElementGroup>, IElementGroupRepository
    {
        ...
        public async Task<ResultWithError> CreateAsync(ElementGroupInputDTO param)
        {
            try
            {
                ...
                var data = Map<ElementGroupInputDTO, ElementGroup>(param, new ElementGroup());
                data.IS_ACTIVE = true;
        ...
        public async Task<ResultWithError> UpdateAsync(ElementGroupInputDTO param)
        {
            try
            {
                ...
                var data = Map<ElementGroupInputDTO, ElementGroup>(param, r);
