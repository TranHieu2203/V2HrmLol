...
{
    public class SalaryImportRepository : TLARepository<SalaryImport>, ISalaryImportRepository
    {
        ...
        {
            var ds = QueryData.ExecuteStoreToTable("PKG_IMPORT.SAL_IMPORT_LIST",
                new
                {
